#!/usr/bin/env python3
"""
OCR 5 sample pages and save output for quality review.
"""
...
def ocr_with_openai(image_bytes: bytes, client: OpenAI) -> dict:
...
def main():
    ...
    output_dir = "/home/johny02/projects/thuvienphapluat-crawler/ocr/data/sample_ocr"
    
    os.makedirs(output_dir, exist_ok=True)
    
    # Sample 5 diverse pages: cover, table start, middle tables, end
    ...
    print(f"📄 OCR {len(sample_pages)} sample pages from {total_pages} total pages")
